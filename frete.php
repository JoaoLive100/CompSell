<?php
 ...
 $cep_origem = 12242003;  //da loja ou do correio de onde foi postado
 
 $resultado = calculaFrete('40010',$cep_origem, $cep, '1', '15', '30', '40', 0 );

 echo sprintf("%0.2f", str_replace(",", ".", $resultado["valor"]) );
